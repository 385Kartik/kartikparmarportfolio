          ...
          <div className="flex gap-4 mb-6">
            {project.liveUrl && (
              <a href={project.liveUrl} target="_blank" rel="noreferrer"
                className="flex items-center gap-2 text-sm font-mono text-black bg-white hover:bg-white/90 transition-colors px-6 py-2.5 rounded-full font-semibold border border-transparent">
                <ExternalLink className="w-4 h-4" /> LIVE PREVIEW
              </a>
            )}
            {project.githubUrl && (
              <a href={project.githubUrl} target="_blank" rel="noreferrer"
                className="flex items-center gap-2 text-sm font-mono text-white/80 hover:text-white hover:bg-white/10 transition-colors px-6 py-2.5 rounded-full border border-white/20">
...
export default function CaseStudyPage() {
  ...
  return (
    ...
    >
      ...
      {/* ── BODY OVERLAY ── */}
      <div className="bg-[#030303] rounded-t-[3rem] -mt-12 relative z-20 overflow-hidden shadow-[0_-40px_80px_rgba(0,0,0,0.8)]">
